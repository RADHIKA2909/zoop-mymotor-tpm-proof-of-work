...
import { ReliabilityHeroVisual } from './ReliabilityHeroVisual'
import s from './ReliabilityHero.module.css'
        ...
        <div className={s.grid}>
          <div className={s.text}>
            ...
            <h1 className={s.title}>
              {HERO.titleLead} <span className={s.accent}>{HERO.titleAccent}</span>
            </h1>
